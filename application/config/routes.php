...
$route['admin/rider'] = 'admin_rider/index';
$route['admin/rider/add'] = 'admin_rider/add';
$route['admin/rider/update'] = 'admin_rider/update';
$route['admin/rider/update/(:any)'] = 'admin_rider/update/$1';
$route['admin/rider/delete/(:any)'] = 'admin_rider/delete/$1';
$route['admin/rider/(:any)'] = 'admin_rider/index/$1'; //$1 = page number

$route['admin/masterhub'] = 'admin_masterhub/index';
$route['admin/masterhub/add'] = 'admin_masterhub/add';
$route['admin/masterhub/update'] = 'admin_masterhub/update';
$route['admin/masterhub/update/(:any)'] = 'admin_masterhub/update/$1';
$route['admin/masterhub/delete/(:any)'] = 'admin_masterhub/delete/$1';
$route['admin/masterhub/(:any)'] = 'admin_masterhub/index/$1'; //$1 = page number
